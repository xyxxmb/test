...
import com.buptyouth.service.RoomService;
...
public class RoomController {
    ...
    JSONObject get_by_date(@RequestBody HashMap<String, Object> reqData) throws ParseException {
        ...
        String[][] re = roomService.getRoomByDate(target_type, target_id, date_str);
    ...
    @RequestMapping(value = "/room_apply", method = RequestMethod.POST)
    private @ResponseBody JSONObject roomApply(@RequestBody HashMap<String, Object> reqData) throws ParseException {
        ...
        int re = roomService.roomApply(user_id, applicant_type, activity_name, people_number,
