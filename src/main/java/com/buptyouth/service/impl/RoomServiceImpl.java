...
public class RoomServiceImpl implements RoomService {
    ...
    @Override
    public String[][] getRoomByDate(int target_type, int target_id, String date_str) throws ParseException {
    ...
    @Override
    public int roomApply(String user_id, int applicant_type, String activity_name, int people_number,
