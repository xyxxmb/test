...
public interface DeviceService{
    String[][] getDeviceByDate(int target_type, int target_id, String date_str) throws ParseException;//date_str yyyy-MM-dd
    int deviceApply(String user_id, int applicant_type, String activity_name, int people_number,
